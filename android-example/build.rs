...
lazy_static! {
    static ref INCLUDE_SYS_H: Vec<&'static str> = env!("INCLUDE_SYS_H","You forgot to export INCLUDE_SYS_H").trim().split(',').collect();
    static ref RUST_SRC_DIR: &'static str = env!("RUST_SRC_DIR","You forgot to export RUST_SRC_DIR");
    static ref ANDROID_BASE_DIR: &'static str = env!("ANDROID_BASE_DIR","You forgot to export ANDROID_BASE_DIR");
    static ref ANDROID_PACKAGE_ID: &'static str = env!("ANDROID_PACKAGE_ID","You forgot to export ANDROID_PACKAGE_ID");
}
...
fn gen_for_android() {
    ...
    for _entry in WalkDir::new(*RUST_SRC_DIR) {
        ...
        rust_swig_expand(&src_dir, &swigf, &out_dir);
    ...
    let swig_gen = rust_swig::Generator::new(LanguageConfig::JavaConfig(
        JavaConfig::new(
            Path::new(*ANDROID_BASE_DIR)
                ...
                .join("generated")
                .join("rust_jni_interface"),
            format!("{}{}", *ANDROID_PACKAGE_ID, ".generated.rust_jni_interface"),
        )
